...
def page2():
    url = 'https://www.wsop.com/tournaments/results/?aid=2&grid=1622&tid=17298&dayof=7651&rr=-1&curpage=2'
    ...
    df.to_csv('C:/Users/Daniel/PycharmProjects/Web_scrapping/2WSOP/data/page_two.csv', index=False)
